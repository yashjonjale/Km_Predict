...
#PBS -N pipeline_II
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Dataset/logs/HPC_pipeline_II_jun_12_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/pipeline_II_jun_12_1.log"
...
echo "Starting Pipeline II"
log_message "Starting Pipeline II"

echo "Running add_esm.py"
log_message "Running add_esm.py"
python3 ./final_pipeline/add_esm.py
...
echo "Dataset Pipeline - II completed successfully"
log_message "Dataset Pipeline - II completed successfully"
