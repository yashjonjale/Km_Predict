...
#PBS -l select=1:ncpus=2:mem=50GB:ngpus=0:accelerator_model=gtx1080ti
#PBS -A km_enz_var
#PBS -N pipeline_I
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Dataset/logs/HPC_pipeline_I_jun_12_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/pipeline_I_jun_12_1.log"
...
## now transfer all files with the form *sub.csv into a new folder called sub_files_transfer
mkdir sub_files_transfer
ls -l ./cache_dir/*sub.csv | wc -l | echo "Number of files to transfer: $1"
mv ./cache_dir/*sub.csv sub_files_transfer
echo "Files transferred successfully"
#Then scp the folder to the local machine scp -r not81yan@storage.hpc.rz.uni-duesseldorf.de:/home/not81yan/km_predict_proj/Dataset/sub_files_transfer/ ./sub_files_transfer
mkdir refined_data_seq

echo "Dataset Pipeline - I completed successfully"
log_message "Dataset Pipeline - I completed successfully"

echo "Run transfer.sh locally"
