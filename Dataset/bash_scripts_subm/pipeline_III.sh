...
# #PBS -l select=1:ncpus=2:mem=25GB:ngpus=1:accelerator_model=gtx1080ti
# #PBS -A km_enz_var
# #PBS -N pipeline_III
# #PBS -j oe
# #PBS -o /home/not81yan/km_predict_proj/Dataset/logs/HPC_pipeline_III_jun_14_1.log
# #PBS -r y
# #PBS -m ae
...
echo "Starting Pipeline III"
log_message "Starting Pipeline III"


echo "Transferring files from HPC to local"
log_message "Transferring files from HPC to local"
# scp -r not81yan@storage.hpc.rz.uni-duesseldorf.de:/home/not81yan/km_predict_proj/Dataset/refined_data_esm/ /home/yashjonjale/Documents/intern_proj/Dataset/refined_data_esm/
echo "Transfer completed successfully"
log_message "Transfer completed successfully"
echo "Running make_pairs.py"
log_message "Running make_pairs.py"
python3 ./final_pipeline/make_pairs.py

echo "Done with make_pairs.py"
log_message "Done with make_pairs.py"



echo "Dataset Pipeline - III completed successfully"
log_message "Dataset Pipeline - III completed successfully"
