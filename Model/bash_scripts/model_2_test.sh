...
#PBS -N pipeline_IV
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Model/logs/HPC_model_2_train_jun_20_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/model_2_test_entire_jun_20_1.log"
...
python3 ./model_files/model_2.py
