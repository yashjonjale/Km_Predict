...
#PBS -N model_4
#PBS -j oe
## PBS -o /home/not81yan/km_predict_proj/Model/logs/HPC_model_4_train_jun_24_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/model_4_${VAR1}_jun_20_1.log"
...
python3 ./model_files/model_5.py --evals $VAR1
