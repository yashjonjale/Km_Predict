...
#PBS -l select=1:ncpus=1:mem=25GB:ngpus=1:accelerator_model=gtx1080ti
#PBS -A km_enz_var
#PBS -N pipeline_IV
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Model/logs/HPC_umap_jul_2.log
#PBS -r y
#PBS -m ae
...
pip install --user -i http://pypi.repo.test.hhu.de/simple/ --trusted-host pypi.repo.test.hhu.de typing-extensions==3.7.4 --upgrade scikit-learn tqdm umap-learn


LOGFILE="./logs/umap_jul_2_1.log"
...
# python3 ./model_files/model_1.py
