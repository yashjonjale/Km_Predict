...
#PBS -N pipeline_IV
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Model/logs/HPC_model_3_train_jun_20_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/model_test_entire_3_jun_20_1.log"
...
python3 ./model_files/model_3.py
