...
#PBS -l select=1:ncpus=1:mem=20GB:ngpus=1:accelerator_model=rtx6000
#PBS -A km_enz_var
#PBS -N classifier
#PBS -j oe
## PBS -o /home/not81yan/km_predict_proj/Model/logs/HPC_clsfr_train_jun_28_1.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/clsfr_200_${VAR1}_jul_1_1.log"
...
python3 ./model_files/classifier.py --evals 200 --sz ${VAR1}
