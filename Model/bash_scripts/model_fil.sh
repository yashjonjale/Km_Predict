...
#PBS -j oe
#PBS -o /home/not81yan/km_predict_proj/Dataset/logs/HPC_model_fil_jul_9.log
#PBS -r y
#PBS -m ae
...
LOGFILE="./logs/model_fil_jul_9.log"
...
python3 ./refined_model/split_train_test.py
# python3 ./refined_model/model.py
