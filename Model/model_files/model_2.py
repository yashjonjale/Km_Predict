...
# start the logger
log_file_path = './logs/model_entire_2.log'
...
y = arr[:, 2]
real = arr[:, 1]#km_wild
X_train, X_test, y_train, y_test,r_train,r_test = train_test_split(X, y,real, test_size=0.2, random_state=42)
...
import json
with open('./logs/best_params_entire_2.json', 'w') as f:
